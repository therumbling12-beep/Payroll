...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <!-- HMO Healthcare Enrolled -->
        <div class="bg-white rounded-2xl border border-gray-100 p-5 shadow-xs transition-all hover:shadow-md">
            <div class="flex items-center justify-between mb-3">
                <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Active HMO Coverage</span>
            ...
            <div class="text-2xl font-black font-outfit text-purple-600">{{ $activeHmoEnrolled }} Policies</div>
            <p class="text-[11px] text-gray-500 mt-1 font-medium">Workforce healthcare protection active</p>
        </div>
