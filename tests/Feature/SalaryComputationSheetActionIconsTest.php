...
test('salary computation manual sheet renders direct payslip action column and batch shortcut', function () {
    ...
    $response->assertSee('Batch Payslips');
    $response->assertSee('Payslip');
});
